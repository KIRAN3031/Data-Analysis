...
# def fetch_air_quality_data(city:str):
...
#     data=resp.json()
#     filename=RAW_DIR/f"air_quality_{city}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
#     filename.write_text(json.dumps(data,indent=2))
#     print(f"✅ Fetched air quality data for city={city} and saved to: {filename}")
#     return str(filename)

# if __name__=="__main__":
#     fetch_air_quality_data("Hyderabad")
#     fetch_air_quality_data("Mumbai")
#     fetch_air_quality_data("Delhi")
